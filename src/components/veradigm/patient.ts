...
import { getVeradigmAccessToken } from "../../helpers/getVeradigmAccessToken";
...
export const getVeradigmPatientData = async (req: Request, res: Response) => {
	try {
		// const { familyName, birthDate } = req.query;
		const accessToken = (await getVeradigmAccessToken()) as string;
